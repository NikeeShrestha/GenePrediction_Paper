...
class base:
    ...
    def preProcess_features(self, **kwargs):
        ...
        elif kwargs["rescale_type"].lower() == "none":
            print("rescaling technique not implemented \n Using featurs directly")
            features_processed =np.array(self.features)
        else:
...
class RF(base):
    ...
    def grid_search(self, **kwargs):
        ...
        max_features= [1, 2, 3, 4, 0.1, 0.2, 0.5, 0.7, 'sqrt', 'log2', None]
        ...
        random_grid = {
            ...
            "bootstrap": bootstrap}
        imputer=('imputer', SimpleImputer(strategy='mean',add_indicator=True))
        ...
        # pipeline=Pipeline(steps=[imputer,('random forest', rf_random)])
    ...
    def train_rf(self, **kwargs):
        ...
        model = RandomForestClassifier(
            ...
            bootstrap=self.ran_params["bootstrap"])
        print("training")
        # pipeline=Pipeline(steps=[imputer,('random forest', model)])
    ...
    def run_CVs(self, **kwargs):
        ...
        # pipeline = Pipeline([
        #     ('imputer', SimpleImputer(strategy='mean',add_indicator=True)),  # Choose an appropriate strategy
